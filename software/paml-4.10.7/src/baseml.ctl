      seqfile = ../examples/ndata/4s-ndata.txt * sequence data filename
     treefile = ../examples/ndata/4s-ndata-maintree.trees * tree Structure file name
...
*        model = 10 [5 (AC CA) (AG GA) (AT TA) (CG GC) (CT TC)] /* SYM */
        ...
        ndata = 3 maintree 1  # run ML using subtrees generated from maintree
